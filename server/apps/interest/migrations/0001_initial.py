...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interest_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('interest', ['Category'])

        # Adding model 'Interest'
        db.create_table('interest_interest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['interest.Category'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('interest_category')
